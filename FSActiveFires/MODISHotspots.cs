...
namespace FSActiveFires
{
    class MODISHotspots
    {
        ...
        public MODISHotspots()
        {
            ...
            datasets.Add("World", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_Global_24h.{1}");
            datasets.Add("Alaska", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_Alaska_24h.{1}");
            datasets.Add("Australia and New Zealand", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_Australia_and_New_Zealand_24h.{1}");
            datasets.Add("Canada", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_Canada_24h.{1}");
            datasets.Add("Central America", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_Central_America_24h.{1}");
            datasets.Add("Europe", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_Europe_24h.{1}");
            datasets.Add("Northern and Central Africa", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_Northern_and_Central_Africa_24h.{1}");
            datasets.Add("Russia and Asia", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_Russia_and_Asia_24h.{1}");
            datasets.Add("South America", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_South_America_24h.{1}");
            datasets.Add("South Asia", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_South_Asia_24h.{1}");
            datasets.Add("South East Asia", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_SouthEast_Asia_24h.{1}");
            datasets.Add("Southern Africa", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_Southern_Africa_24h.{1}");
            datasets.Add("U.S.A. (Conterminous) and Hawaii", "https://firms.modaps.eosdis.nasa.gov/active_fire/c6/{0}/MODIS_C6_USA_contiguous_and_Hawaii_24h.{1}");
